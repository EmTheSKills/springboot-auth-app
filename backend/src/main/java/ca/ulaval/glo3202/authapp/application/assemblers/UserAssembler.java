...
public class UserAssembler {
    public UserCreationDto toUserCreationDto(UserDomain user) {
        return new UserCreationDto(user.getStringUserId(), user.getFirstName(), user.getLastName(), user.getUsername(), user.getEmail(), user.getCreation(), user.getStringPassword());
    }
}
